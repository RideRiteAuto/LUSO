...
5. **Environmental truth** — derive temperature, precipitation, moisture, wetness, drainage, water distance, shoreline influence, slope, exposure, erosion/scree, soil, geology, weather region, buildability, vegetation eligibility, and resource eligibility. Regional biases come from `data/design/environment-regions.json`, which is authored from Bible v11. These fields are compiler truth; renderer noise may only break up their visual presentation.
